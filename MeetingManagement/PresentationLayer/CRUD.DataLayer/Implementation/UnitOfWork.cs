...
namespace CRUD.DataLayer.Implementation
{
    ...
    public class UnitOfWork : IDisposable
    {
        ...
        private DataAccess<MeetingInfo> meetingInfoRepository;
        ...
        /// <summary>
        /// Gets the get attendee repository.
        /// </summary>
        /// <value>
        /// The get attendee repository.
        /// </value>

        public DataAccess<MeetingInfo> GetMeetingRepository
        {
            get
            {
                if (this.meetingInfoRepository == null)
                {
                    this.meetingInfoRepository = new DataAccess<MeetingInfo>(this.objMyModel);
                }
